...
namespace BGuest.Integration.Console.Net20
{
    public class Importer
    {
        ...
        public static string StayDataToString(StayData stayData)
        {
            return $"{stayData.HotelId};{stayData.ExternalKey};{stayData.Room};{stayData.IsCheckedIn};{stayData.State};{stayData.PeriodStart};{stayData.PeriodEnd};"
                + $"{stayData.GuestEmail};{stayData.GuestFirstName};{stayData.GuestLastName}";
        }
            ...
            string baseUriString)
        {
            ...
            {
                foreach (var reservationResult in responseBGuest.Data)
                {
